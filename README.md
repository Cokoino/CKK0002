...
- Then,there will pop up a download task which named"CKK0002-main". 
- You will get a "CKK0002-main"ZIP file in your computer when the download task is finished,
